...
class SaleExpenseDocumentController extends Controller
{
    public function index(Request $request)
    {
        ...
        return SaleExpenseDocumentService::index($requestAll);
    }
    ...
    public function create(Request $request)
    {
        try {
            ...
            return SaleExpenseDocumentService::create($data);
        } catch (Exception $e){
            return $e->getMessage();
        }
    }
    ...
    public function card(Request $request)
    {
        ...
        $id = $request->input('id');
        $data = SaleExpenseDocumentService::card($id);
    ...
    public function update(Request $request)
    {
        try {
            ...
            $result = SaleExpenseDocumentService::update($id, $data);
    ...
    public function destroy(Request $request)
    {
        ...
        $id = $request->input('id');
        $data = SaleExpenseDocumentService::delete($id);
        if(!$data) return response()->json(['message'=>'Not found'], 404);
        return $data;
    }
    ...
    public function recover(Request $request)
    {
        ...
        $id = $request->input('id');
        $data = SaleExpenseDocumentService::recover($id);
        if(!$data) return response()->json(['message'=>'Not found'], 404);
        return $data;
    }
