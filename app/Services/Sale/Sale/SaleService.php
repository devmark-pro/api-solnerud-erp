...
class SaleService
{
    ...
    public static function update($id, $data){ 
        try {
            Sale::where('id', $id)->first()->update($data);
            return Sale::where('id', $id)
                //->with([])
                ->first();
    ...
    public static function delete($id){ 
        try {
            return Sale::where('id', $id)->first()->update(['deleted_at' => now()]);
        } catch (Exception $e) {
            return $e->getMessage();
        }
    }
    public static function recover($id){ 
        try {
            return Sale::where('id', $id)->fitst()->update(['deleted_at' => null]);
        } catch (Exception $e) {
            return $e->getMessage();
        }
    }
    public static function field($id, $field){ 
        try {
            $result = Sale::where('id', $id)->select($field)->first();
            if(!$result ) return;
            return $result[$field];
        } catch (Exception $e) {
            return $e->getMessage();
