...
class RoleService
{
    ...
    public static function update($id, $data){ 
        try {
            Role::where('id', $id)->first()->update($data);
            return Role::where('id', $id)
                //->with([])
                ->first();
    ...
    public static function delete($id){ 
        try {
            return Role::where('id', $id)->update(['deleted_at' => now()]);
        } catch (Exception $e) {
            return $e->getMessage();
        }
    }
    public static function recover($id){ 
        try {
            return Role::where('id', $id)->update(['deleted_at' => null]);
        } catch (Exception $e) {
            return $e->getMessage();
        }
    }
    public static function field($id, $field){ 
        try {
            $result = Role::where('id', $id)->select($field)->first();
            if(!$result ) return;
            return $result[$field];
        } catch (Exception $e) {
            return $e->getMessage();
