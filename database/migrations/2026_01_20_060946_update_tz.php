    ...
    public function up(): void
    {
        ...
        if (Schema::hasColumn('purchase_account_suppliers', 'deleted_at')) {
            Schema::table('purchase_account_suppliers', function (Blueprint $table) {
                ...
                $table->timestampTz('created_at')->nullable()->change();
                $table->timestampTz('updated_at')->nullable()->change();
                $table->timestampTz('payment_date')->nullable()->change();                
            });
        }
        ...
        if (Schema::hasColumn('purchase_expenses', 'deleted_at')) {
            Schema::table('purchase_expenses', function (Blueprint $table) {
                ...
                $table->timestampTz('created_at')->nullable()->change();
                $table->timestampTz('updated_at')->nullable()->change();
                $table->timestampTz('service_date_from')->nullable()->change();
                $table->timestampTz('service_date_to')->nullable()->change();
                $table->timestampTz('reimbursement_date')->nullable()->change();
            });
        }
        
        if (Schema::hasColumn('purchase_invoices', 'deleted_at')) {
            Schema::table('purchase_invoices', function (Blueprint $table) {
                $table->timestampTz('date')->nullable()->change();
                $table->timestampTz('deleted_at')->nullable()->change();
                $table->timestampTz('created_at')->nullable()->change();
                $table->timestampTz('updated_at')->nullable()->change();
            });
        ...
        if (Schema::hasColumn('purchase_receipts', 'deleted_at')) {
            Schema::table('purchase_receipts', function (Blueprint $table) {
                ...
                $table->timestampTz('created_at')->nullable()->change();
                $table->timestampTz('updated_at')->nullable()->change();
                $table->timestampTz('dispatch_date')->nullable()->change();
                $table->timestampTz('arrival_date')->nullable()->change();
                $table->timestampTz('invoice_supplier_date')->nullable()->change();
                $table->timestampTz('invoice_our_date')->nullable()->change();       
            });
        }
        ...
        if (Schema::hasColumn('sale_shipments', 'deleted_at')) {
            Schema::table('sale_shipments', function (Blueprint $table) {
                ...
                $table->timestampTz('created_at')->nullable()->change();
                $table->timestampTz('updated_at')->nullable()->change();
                $table->timestampTz('shipment_date')->nullable()->change();
                $table->timestampTz('file_date')->nullable()->change();
            });
        }
