...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('roles', function (Blueprint $table) {
            ...
            $table->boolean('nomenclature_r')->default(false); 
